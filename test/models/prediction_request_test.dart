...
void main() {
  group('PredictionRequest', () {
    ...
    PredictionRequest createSample({
      ...
      int hour = 14,
      double temperature2m = 28.0,
      double relativeHumidity2m = 70.0,
      double rain = 0.0,
      double surfacePressure = 1010.0,
      double cloudCover = 40.0,
      double cloudCoverLow = 10.0,
      double cloudCoverMid = 20.0,
      double cloudCoverHigh = 30.0,
      double windSpeed10m = 10.0,
      double windSpeed100m = 15.0,
      double windDirection10m = 180.0,
      double windDirection100m = 180.0,
      double windGusts10m = 12.0,
      String? acType,
      String? origin,
      String? destination,
      int? weatherCode,
